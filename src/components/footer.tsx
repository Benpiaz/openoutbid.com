  ...
  return (
    <footer className="mx-auto w-full max-w-6xl text-center">
      <p className="text-xs leading-relaxed text-muted-foreground">
        ...
        · Founded by{" "}
        <a href="https://github.com/benpiaz" target="_blank" rel="noopener noreferrer" className="text-primary transition-colors hover:text-primary/80">
          benpiaz
        </a>{" "}
      ...
      <div className="mt-4 flex flex-wrap items-center justify-center gap-2 text-xs text-muted-foreground/60">
        <span className="inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-3 py-1">
          <span className="font-bold text-primary">DR</span> openoutbid.com — domain rating ·{" "}
          <a href="https://openoutbid.com" target="_blank" rel="noopener noreferrer" className="underline">
            check
          </a>
        </span>
